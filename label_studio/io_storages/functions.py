...
from .deeplake.api import DeepLakeImportStorageListAPI, DeepLakeExportStorageListAPI
...
def get_storage_list():
    return [
        ...
        {'name': 'deeplake', 'title': 'Deep Lake', 'import_list_api': DeepLakeImportStorageListAPI, 'export_list_api': DeepLakeExportStorageListAPI}
    ]