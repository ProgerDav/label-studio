...
LOCAL_FILES_DOCUMENT_ROOT = get_env('LOCAL_FILES_DOCUMENT_ROOT', default="")
DEEPLAKE_FILES_DOCUMENT_ROOT = get_env('DEEPLAKE_FILES_DOCUMENT_ROOT', default="")
DEEPLAKE_FILES_API_KEY = get_env('DEEPLAKE_FILES_API_KEY', default="")
